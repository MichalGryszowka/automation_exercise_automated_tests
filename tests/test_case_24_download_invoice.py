...
def test_case_24_download_invoice(get_main_page):
    ...
    payment_done.click_element(locators.PaymentDone.download_invoice)

    # Verify invoice is downloaded successfully
    assert payment_done.check_file_download('C://Users//HP//Downloads//invoice.txt') is True

    main_page = payment_done.click_button(locators.PaymentDone.continue_btn, MainPage)

    delete_account_page = main_page.click_button(locators.Main.delete_account, DeleteAccountPage)
