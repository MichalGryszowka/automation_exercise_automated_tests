...
def test_case_14_place_order_register_with_check_out(get_main_page):
    ...
    payment_page.click_element(locators.Payment.pay_and_confirm_btn)

    delete_account_page = payment_page.click_button(locators.Payment.delete_my_account, DeleteAccountPage)
